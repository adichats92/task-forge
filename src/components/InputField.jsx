...
const InputField = ({setTaskCards}) => {
  ...
  const handleSubmit = (e) => {
    ...
    setTaskCardInput({ title: "", details: "", location:"",priority: "", time: "" });
  ...
  return (
    <Form onSubmit={handleSubmit} className='mb-2'>
      ...
      controlId="formGridDetails">
        ...
        <Form.Group className="my-3 px-1" 
        as={Col} xs={{ span: 12, offset: 0 }} md={{ span: 6, offset: 3 }} xl={{ span: 4, offset: 4 }}   controlId="formGridLocation">
        ...
        <Form.Group className="my-3 px-1" as={Col} xs={{ span: 12, offset: 0 }} md={{ span: 6, offset: 3 }} xl={{ span: 4, offset: 4 }} controlId="formGridTime">
